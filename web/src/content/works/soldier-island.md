...
banner: /works/covers/ai-collab-banner.png
year: 2026
...
针对「整本小说改编为可玩游戏」的复杂任务，设计「**模型研读原著 → 自提炼提示词 → 人工审查校准 → 分阶段执行**」的人机协作工作流：

- 按 M0–M6 里程碑拆解任务，逐阶段设定验收标准；
- 保障跨十余小时长程任务中的上下文一致性与产出质量；
- 过程中人仅承担需求定义、方案审查与关键决策，**AI 完成 70%+ 的执行工作**。
